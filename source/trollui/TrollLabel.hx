...
{
    public function new(x: Float, y:Float, fieldWidth: Float = 0, text:String = "") 
	{
		super(x, y, fieldWidth, text, 12);
		setFormat("assets/fonts/segoeui.ttf", 12, FlxColor.WHITE, FlxTextAlign.LEFT, FlxTextBorderStyle.OUTLINE_FAST, FlxColor.BLACK); // TODO: Change to Paths in troll engine
		active = false;
	}
}